...
//  NIKE_Concept_UI
//
//  Created by rutik maraskolhe on 14/07/21.
//
...
struct Data {
    ...
    static let shoes = [
        ShoeItem(name: "Nike Tiempo Legend IV FG Black", image: "1", price: 250, availableSize: [5.5, 6.0, 7.0, 8.0, 9.5, 10]),
        ShoeItem(name: "Nike Tiempo Legend IV FG Neon", image: "2", price: 300, availableSize: [5.5, 6.0, 8.0, 9.5, 10]),
        ShoeItem(name: "Nike Hypervenom Phelon", image: "3", price: 280, availableSize: [7.0, 8.0, 9.5, 10]),
        ShoeItem(name: "Nike Mercurial Dream Orange", image: "4", price: 170, availableSize: [5.5, 7.0, 8.0, 10]),
        ShoeItem(name: "Nike Mercurial Dream Sky Blue", image: "5", price: 120, availableSize: [5.5, 6.0, 7.0, 8.0, 9.5]),
        ShoeItem(name: "Nike Tiempo Legend", image: "6", price: 200, availableSize: [5.5, 6.0, 7.0, 8.0, 9.5, 10.0]),
        ShoeItem(name: "Nike Mercurial Dream Silver", image: "7", price: 220, availableSize: [6.0, 9.5, 10.0])
    ]
